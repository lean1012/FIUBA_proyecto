...
#define SHT4X_I2C_ADDRESS (0x44U)
 ...
 */
static int16_t convert_ticks_to_celsius(uint16_t ticks, uint16_t * temp_h, uint16_t *temp_l) {
	/**
	 * Temperature = 175 * S_T / 65535 - 45
	 */
    
	/**
	 * Temperature decimal t_val->val2 = (((t_ticks * 175) % 65535)*10)/65535;
	*/
	

	
	*temp_h = ((ticks * 175) / 65535) - 45;
	*temp_l = (((ticks * 175) % 65535)*10)/65535;
...
int8_t sht4x_temp_hum_low_presition(uint16_t * temperature_h, uint16_t * temperature_l, uint16_t* humidity){
	...
	convert_ticks_to_celsius(temp_ticks, temperature_h, temperature_l);
	*humidity = convert_ticks_to_percent_rh(hum_ticks);
	return 0;
}

int8_t sht4x_temp_hum_medium_presition(uint16_t * temperature_h, uint16_t * temperature_l, uint16_t* humidity){
...
int8_t sht4x_temp_hum_high_presition(uint16_t * temperature_h, uint16_t * temperature_l, uint16_t* humidity){
